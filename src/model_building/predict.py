...
def main():
    ...
    for data_set, dataloader in [(train_data,train_dataloader), (test_data, test_dataloader),(val_data, val_dataloader)]:
        ...
        scores = map_class_to_scores(predicts,y_trues, train_data.idx_to_label, args.emotion_map_dict)
        ...
        # 将res_write_to_json转换为dataframe
